...
public partial class DemoDb2550NorthwindContext : DbContext
{
    public DemoDb2550NorthwindContext()
    {
    }

    public DemoDb2550NorthwindContext(DbContextOptions<DemoDb2550NorthwindContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=data.cnt.sast.ca,24680;Database=demo_db2550_Northwind;User Id=demoUser;Password= temP2020#;Encrypt=False;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Invoice>(entity =>
        {
            ...
            entity.Property(e => e.Salesperson).HasMaxLength(41);
